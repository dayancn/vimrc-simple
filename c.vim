...
if has("gui_running")
   ...
   exec "hi Error80        cterm=NONE ctermfg=7 ctermbg=1"
   exec "hi ErrorLeadSpace cterm=NONE ctermfg=7 ctermbg=1"
   exec "hi ErrorTailSpace cterm=NONE ctermfg=7 ctermbg=1"
endif
...
source ~/.vim/plugin/ccommenter.vim
